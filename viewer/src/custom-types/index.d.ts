// types copied from use-pan-and-zoom (it has types but doesn't export them correctly)
declare module "use-pan-and-zoom" {
  ...
  export declare function dist(a: position, b: position): number;
  export declare function getPositionOnElement(
